class Tabs {
    constructor({
        rootSelector,
        activeContrlClass = 'active',
        activePaneClass = 'active',
        activeTab = 1
    }) {

        this._refs = this._getRefs(rootSelector);
        this._activeControlClass = activeContrlClass;
    ...
    _removeActiveTab({ currentTarget } ) {
        const currentActiveControlItem = currentTarget.querySelector(
...
const tabs1 = new Tabs({
    rootSelector: '#tabs-1',
    activeContrlClass: 'controls__item--active',
